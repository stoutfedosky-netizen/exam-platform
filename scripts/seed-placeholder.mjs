...
const questions = [
  // ── 3 Logical Reasoning discretes ──
  {
    ...
    batch: "PLACEHOLDER",
    sort_order: 1,
    passage: "A recent study conducted by the National Institute for Urban Health examined stress levels across 147 metropolitan areas in the United States and Canada over a twelve-year period. The researchers found that cities with more public parks per capita consistently reported lower rates of chronic stress among their residents. Importantly, the study controlled for a wide range of potentially confounding variables, including median household income, population density, average commute times, climate, unemployment rates, and access to healthcare facilities.\n\nThe study's lead author, Dr. Elena Marchetti, noted that the correlation between park density and reduced stress was remarkably robust across geographic regions, demographic groups, and economic conditions. Even in cities with high poverty rates, neighborhoods adjacent to large public parks showed measurably lower stress indicators than comparable neighborhoods without nearby green space. The researchers employed both self-reported stress surveys and physiological markers — including cortisol levels measured through hair samples — to triangulate their findings.\n\nCritics of the study have raised several methodological concerns. Professor James Whitfield of the Georgetown School of Public Policy argued that the study's reliance on metropolitan-level data obscures important neighborhood-level variation. He pointed out that within any given city, parks are not distributed equally: wealthier neighborhoods tend to have more and better-maintained parks, while lower-income communities often lack accessible green space entirely. This distributional inequality, Whitfield contends, means that the study's aggregate findings may reflect the advantages of wealth rather than the benefits of parks themselves.\n\nOther scholars have questioned the direction of causation. It is possible, they suggest, that cities with lower baseline stress levels — perhaps due to stronger community institutions, better governance, or more temperate climates — are also the cities that invest more heavily in public amenities, including parks. Under this interpretation, parks and low stress are both consequences of underlying civic health rather than standing in a causal relationship to each other.\n\nDr. Marchetti has acknowledged these concerns but maintains that her team's longitudinal design addresses many of them. Because the study tracked changes over time, the researchers were able to observe that new park construction in previously underserved neighborhoods was followed, within three to five years, by measurable declines in reported stress — a pattern difficult to explain through reverse causation alone.",
